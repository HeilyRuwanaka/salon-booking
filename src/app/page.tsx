...
export default async function HomePage() {
  ...
  return (
    <>
      {/* Hero — one composition: brand, line, CTAs, photo */}
        ...
        <div className="relative mx-auto flex min-h-[calc(100vh-4rem)] max-w-6xl flex-col justify-end px-4 pb-16 pt-28 sm:px-6 sm:pb-20">
          ...
          <div className="animate-rise-delay-2 mt-8 flex flex-wrap gap-3">
            ...
            <a
              ...
              className="btn btn-ghost border-white/25 text-stone"
            >
              WhatsApp
            </a>
      ...
      {/* Services preview */}
      <section className="border-t border-line bg-stone/80">
        <div className="mx-auto max-w-6xl px-4 py-16 sm:px-6">
          ...
          <Link href="/services" className="mt-8 inline-block text-sm font-semibold text-copper-deep underline-offset-4 hover:underline">
            See all services
          </Link>
        </div>
      </section>
        ...
        <div className="mx-auto grid max-w-6xl gap-10 px-4 py-16 sm:px-6 lg:grid-cols-2 lg:items-center">
          ...
          <div>
            ...
            <p className="mt-4 text-mute leading-relaxed">
              {salon.aboutParagraphs[0]}
            </p>
            <p className="mt-3 text-mute leading-relaxed">
              {salon.aboutParagraphs[1]}
            </p>
      ...
      {/* Reviews */}
      <section className="border-t border-line bg-ink text-stone">
        <div className="mx-auto max-w-6xl px-4 py-16 sm:px-6">
          <p className="text-sm font-semibold uppercase tracking-[0.18em] text-sand/70">
            Reviews
          </p>
          <h2 className="font-display mt-3 text-3xl tracking-tight sm:text-4xl">
            What clients say
        ...
        <div className="mx-auto max-w-6xl px-4 py-16 sm:px-6">
          ...
          <div className="mt-10 grid gap-8 sm:grid-cols-2 lg:grid-cols-4">
            <div>
              ...
              <p className="mt-2 font-semibold">{salon.hoursLabel}</p>
            </div>
            <div>
              <p className="text-sm uppercase tracking-wide text-mute">Phone</p>
              <a href={telUrl()} className="mt-2 block font-semibold hover:text-copper-deep">
                {salon.phoneDisplay}
              </a>
            </div>
            <div>
              ...
              <a
                href={whatsappUrl("Hi, I want to book at Ranu Salon")}
                className="mt-2 block font-semibold hover:text-copper-deep"
              >
                Chat to book
              </a>
            </div>
            <div>
              ...
              <p className="mt-2 font-semibold">{salon.address}</p>
              {salon.mapUrl ? (
                <a
                  href={salon.mapUrl}
                  target="_blank"
